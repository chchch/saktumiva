...
const addEditButton = id => {
    ...
    editbutton.dataset.anno = `Edit apparatus for ${id}`;
    editbutton.addEventListener('click',editApp.bind(null,{block: id}));
    block.prepend(editbutton);
};

const fillBlocksAndAddButtons = () => {
