...
const processFile = (teixml, filename, state, idsel = '*|id') => {
    ...
    const overallsiglum = teixml.querySelector('idno[type="siglum"]')?.textContent || teixml.documentElement.getAttribute('n');
    ...
    for(const siglum of [overallsiglum,...textsigla]) {
