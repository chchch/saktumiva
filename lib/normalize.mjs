...
*/
    ...
    },
    {
        ...
        search: 'ṉ(\\s*)([ṟtpkn])',
        replace: (match) => {
            if(match[2] === 'ṟ' && match[1] !== '') return `ṟ${match[1]}ṟ`;
            if(match[2] === 't') return `ṟ${match[1]}ṟ`;
    ...
    },
    {
        ...
        search: 'ḷ(\\s*)([kcptmṇ])',
        replace: (match) => {
            if(match[2] === 'k' && match[1] !== '') return `ṇ${match[1]}k`;
            if(match[2] === 'c') return `ṇ${match[1]}c`;
            if(match[2] === 'p' && match[1] !== '') return `ṇ${match[1]}p`;
            if(match[2] === 't') return 'ṭ';
            if(match[2] === 'm') return `ṇ${match[1]}m`;
            if(match[2] === 'ṇ') return 'ṇ';
        }
    },
    {
        name: 'ignore puḷḷi',
